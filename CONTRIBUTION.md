...
```bash
git clone https://github.com/<your-github-username>/stockinator.git
```
...
**9.** **Congratulations!** Sit and relax, you've made your contribution to [stockinator](https://github.com/ricardoprins/stockinator) project.
